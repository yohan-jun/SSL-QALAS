...
class T2TSESAGMaskFunc(MaskFunc):
    """
    Sample data with equally-spaced k-space lines.
    ...
    def calculate_acceleration_mask(
        ...
        """
        if acceleration == 2:
            mask = scipy.io.loadmat('/data1/YH/fastMRI/DATA/mask_T2_TSE_SAG_r2.mat')
        elif acceleration == 3:
            mask = scipy.io.loadmat('/data1/YH/fastMRI/DATA/mask_T2_TSE_SAG_r3.mat')
        elif acceleration == 4:
            mask = scipy.io.loadmat('/data1/YH/fastMRI/DATA/mask_T2_TSE_SAG_r4.mat')
...
class T2TSECORSPAIRMaskFunc(MaskFunc):
    """
    Sample data with equally-spaced k-space lines.
    ...
    def calculate_acceleration_mask(
        ...
        """
        if acceleration == 2:
            mask = scipy.io.loadmat('/data1/YH/fastMRI/DATA/mask_T2_TSE_COR_SPAIR_r2.mat')
        elif acceleration == 3:
            mask = scipy.io.loadmat('/data1/YH/fastMRI/DATA/mask_T2_TSE_COR_SPAIR_r3.mat')
        elif acceleration == 4:
            mask = scipy.io.loadmat('/data1/YH/fastMRI/DATA/mask_T2_TSE_COR_SPAIR_r4.mat')
        mask = np.array(mask['mask'],dtype=np.float32)
        mask = mask[np.newaxis,:,:,np.newaxis]
        #mask = torch.from_numpy(mask[np.newaxis,:,:,np.newaxis])
...
class VUDUMaskAPFunc(MaskFunc):
    ...
    def calculate_acceleration_mask(
        ...
        """
        if acceleration == 4:
            mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/vudu/mask_VUDU_ap.mat')
        mask = np.array(mask['mask'],dtype=np.float32)
        mask = mask[np.newaxis,:,:,np.newaxis]
        #mask = torch.from_numpy(mask[np.newaxis,:,:,np.newaxis])
...
class VUDUMaskPAFunc(MaskFunc):
    ...
    def calculate_acceleration_mask(
        ...
        """
        if acceleration == 4:
            mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/vudu/mask_VUDU_pa.mat')
        mask = np.array(mask['mask'],dtype=np.float32)
        mask = mask[np.newaxis,:,:,np.newaxis]
        #mask = torch.from_numpy(mask[np.newaxis,:,:,np.newaxis])
...
class QALASMaskFunc(MaskFunc):
    ...
    def calculate_acceleration_mask(
        ...
        """
        # if acceleration == 2:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_QALAS_R2X1.mat')
        # elif acceleration == 3:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_QALAS_R3X1.mat')
        # elif acceleration == 4:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_QALAS_R4X1.mat')
        mask = np.array(mask['mask'],dtype=np.float32)
        mask = mask[np.newaxis,:,:,np.newaxis]
        #mask = torch.from_numpy(mask[np.newaxis,:,:,np.newaxis])
...
class SSQALASMaskFunc(MaskFunc):
    """
    Sample data with equally-spaced k-space lines.
    ...
    def calculate_acceleration_mask(
        ...
        """
        # if acceleration == 2:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_SSQALAS_R2X1.mat')
        # elif acceleration == 3:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_SSQALAS_R3X1.mat')
        # elif acceleration == 4:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_SSQALAS_R4X1.mat')
        mask = np.array(mask['mask'],dtype=np.float32)
        mask = mask[np.newaxis,:,:,np.newaxis]
        #mask = torch.from_numpy(mask[np.newaxis,:,:,np.newaxis])
...
class SSQALASMAPMaskFunc(MaskFunc):
    """
    Sample data with equally-spaced k-space lines.
    ...
    def calculate_acceleration_mask(
        ...
        """
        # if acceleration == 2:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_SSQALASMAP_R2X1.mat')
        # elif acceleration == 3:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_SSQALASMAP_R3X1.mat')
        # elif acceleration == 4:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_SSQALASMAP_R4X1.mat')
        mask = np.array(mask['mask'],dtype=np.float32)
        mask = mask[np.newaxis,:,:,np.newaxis]
        #mask = torch.from_numpy(mask[np.newaxis,:,:,np.newaxis])
...
class ZSQALASMaskFunc(MaskFunc):
    """
    Sample data with equally-spaced k-space lines.
    ...
    def calculate_acceleration_mask(
        ...
        """
        # if acceleration == 2:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_ZSQALAS_R2X1.mat')
        # elif acceleration == 3:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_ZSQALAS_R3X1.mat')
        # elif acceleration == 4:
        #     mask = scipy.io.loadmat('/autofs/space/marduk_003/users/yohan/python_code/fastMRI/DATA/mask_ZSQALAS_R4X1.mat')
        mask = np.array(mask['mask'],dtype=np.float32)
        mask = mask[np.newaxis,:,:,np.newaxis]
        #mask = torch.from_numpy(mask[np.newaxis,:,:,np.newaxis])
...
def create_mask_for_mask_type(
    ...
    elif mask_type_str == "t2_tse_sag":
        return T2TSESAGMaskFunc(center_fractions, accelerations)
    elif mask_type_str == "t2_tse_cor_spair":
        return T2TSECORSPAIRMaskFunc(center_fractions, accelerations)
    elif mask_type_str == "vudu_ap":
        return VUDUMaskAPFunc(center_fractions, accelerations)
    elif mask_type_str == "vudu_pa":
        return VUDUMaskPAFunc(center_fractions, accelerations)
    elif mask_type_str == "grasp":
        return RandomMaskFunc(center_fractions, accelerations)
    elif mask_type_str == "qalas":
        return QALASMaskFunc(center_fractions, accelerations)
    elif mask_type_str == "zsqalas":
        return ZSQALASMaskFunc(center_fractions, accelerations)
    elif mask_type_str == "ssqalas":
        return SSQALASMaskFunc(center_fractions, accelerations)
    elif mask_type_str == "ssqalasmap":
        return SSQALASMAPMaskFunc(center_fractions, accelerations)
    else:
