...
class JICNETDataTransform:
    """
    Data Transformer for training JICNET models.
    """
    ...
    def __call__(
        ...
        Returns:
            A JICNETSample with the masked k-space, sampling mask, target
