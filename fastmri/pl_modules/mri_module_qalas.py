...
class MriModuleQALAS(pl.LightningModule):
    """
    ...
    def validation_step_end(self, val_logs):
        ...
        if val_logs["output_fin_img1"].ndim == 2:
            val_logs["output_fin_img1"] = val_logs["output_fin_img1"].unsqueeze(0)
        elif val_logs["output_fin_img1"].ndim != 3:
            raise RuntimeError("Unexpected output_fin_img1 size from validation_step.")
        if val_logs["output_fin_img2"].ndim == 2:
            val_logs["output_fin_img2"] = val_logs["output_fin_img2"].unsqueeze(0)
        elif val_logs["output_fin_img2"].ndim != 3:
            raise RuntimeError("Unexpected output_fin_img2 size from validation_step.")
        if val_logs["output_fin_img3"].ndim == 2:
            val_logs["output_fin_img3"] = val_logs["output_fin_img3"].unsqueeze(0)
        elif val_logs["output_fin_img3"].ndim != 3:
            raise RuntimeError("Unexpected output_fin_img3 size from validation_step.")
        if val_logs["output_fin_img4"].ndim == 2:
            val_logs["output_fin_img4"] = val_logs["output_fin_img4"].unsqueeze(0)
        elif val_logs["output_fin_img4"].ndim != 3:
            raise RuntimeError("Unexpected output_fin_img4 size from validation_step.")
        if val_logs["output_fin_img5"].ndim == 2:
            val_logs["output_fin_img5"] = val_logs["output_fin_img5"].unsqueeze(0)
        elif val_logs["output_fin_img5"].ndim != 3:
            raise RuntimeError("Unexpected output_fin_img5 size from validation_step.")
        ...
        if val_logs["target_ie"].ndim == 2:
            val_logs["target_ie"] = val_logs["target_ie"].unsqueeze(0)
        elif val_logs["target_ie"].ndim != 3:
            raise RuntimeError("Unexpected target_ie size from validation_step.")
        ...
        for i, batch_idx in enumerate(batch_indices):
            if batch_idx in self.val_log_indices:
                ...
                target_ie = val_logs["target_ie"][i].unsqueeze(0)
                ...
                output_fin_img1 = val_logs["output_fin_img1"][i].unsqueeze(0)
                output_fin_img2 = val_logs["output_fin_img2"][i].unsqueeze(0)
                output_fin_img3 = val_logs["output_fin_img3"][i].unsqueeze(0)
                output_fin_img4 = val_logs["output_fin_img4"][i].unsqueeze(0)
                output_fin_img5 = val_logs["output_fin_img5"][i].unsqueeze(0)

                error_t1 = torch.abs(target_t1 - output_t1)
                error_t2 = torch.abs(target_t2 - output_t2)
                error_pd = torch.abs(target_pd - output_pd)
                error_ie = torch.abs(target_ie - output_ie)
                ...
                error_fin_img1 = torch.abs(target_img1 - output_fin_img1)
                error_fin_img2 = torch.abs(target_img2 - output_fin_img2)
                error_fin_img3 = torch.abs(target_img3 - output_fin_img3)
                error_fin_img4 = torch.abs(target_img4 - output_fin_img4)
                error_fin_img5 = torch.abs(target_img5 - output_fin_img5)
                ...
                output_fin_img1 = output_fin_img1 / output_fin_img1.max()
                output_fin_img2 = output_fin_img2 / output_fin_img2.max()
                output_fin_img3 = output_fin_img3 / output_fin_img3.max()
                output_fin_img4 = output_fin_img4 / output_fin_img4.max()
                output_fin_img5 = output_fin_img5 / output_fin_img5.max()
                target_t1 = target_t1 / target_t1.max()
                target_t2 = target_t2 / target_t2.max()
                target_pd = target_pd / target_pd.max()
                target_ie = target_ie / target_ie.max()
                ...
                error_ie = error_ie / error_ie.max()
                ...
                error_fin_img1 = error_fin_img1 / error_fin_img1.max()
                error_fin_img2 = error_fin_img2 / error_fin_img2.max()
                error_fin_img3 = error_fin_img3 / error_fin_img3.max()
                error_fin_img4 = error_fin_img4 / error_fin_img4.max()
                error_fin_img5 = error_fin_img5 / error_fin_img5.max()

                self.log_image(f"{key}/target", torch.cat((target_t1,target_t2,target_pd,target_ie),-1))
                self.log_image(f"{key}/target_forward", torch.cat((target_img1,target_img2,target_img3,target_img4,target_img5),-1))
                self.log_image(f"{key}/reconstruction", torch.cat((output_t1,output_t2,output_pd,output_ie),-1))
                self.log_image(f"{key}/reconstruction_init_forward", torch.cat((output_img1,output_img2,output_img3,output_img4,output_img5),-1))
                self.log_image(f"{key}/reconstruction_fin_forward", torch.cat((output_fin_img1,output_fin_img2,output_fin_img3,output_fin_img4,output_fin_img5),-1))
                self.log_image(f"{key}/error", torch.cat((error_t1,error_t2,error_pd,error_ie),-1))
                self.log_image(f"{key}/error_init_forward", torch.cat((error_img1,error_img2,error_img3,error_img4,error_img5),-1))
                self.log_image(f"{key}/error_fin_forward", torch.cat((error_fin_img1,error_fin_img2,error_fin_img3,error_fin_img4,error_fin_img5),-1))

        # compute evaluation metrics
        mse_vals_t1 = defaultdict(dict)
        mse_vals_t2 = defaultdict(dict)
        mse_vals_pd = defaultdict(dict)
        mse_vals_ie = defaultdict(dict)
        ...
        mse_vals_fin_img1 = defaultdict(dict)
        mse_vals_fin_img2 = defaultdict(dict)
        mse_vals_fin_img3 = defaultdict(dict)
        mse_vals_fin_img4 = defaultdict(dict)
        mse_vals_fin_img5 = defaultdict(dict)
        target_norms_t1 = defaultdict(dict)
        target_norms_t2 = defaultdict(dict)
        target_norms_pd = defaultdict(dict)
        target_norms_ie = defaultdict(dict)
        ...
        ssim_vals_fin_img1 = defaultdict(dict)
        ssim_vals_fin_img2 = defaultdict(dict)
        ssim_vals_fin_img3 = defaultdict(dict)
        ssim_vals_fin_img4 = defaultdict(dict)
        ssim_vals_fin_img5 = defaultdict(dict)
        max_vals_t1 = dict()
        max_vals_t2 = dict()
        max_vals_pd = dict()
        max_vals_ie = dict()
        ...
        for i, fname in enumerate(val_logs["fname"]):
            ...
            output_fin_img1 = val_logs["output_fin_img1"][i].cpu().numpy()
            output_fin_img2 = val_logs["output_fin_img2"][i].cpu().numpy()
            output_fin_img3 = val_logs["output_fin_img3"][i].cpu().numpy()
            output_fin_img4 = val_logs["output_fin_img4"][i].cpu().numpy()
            output_fin_img5 = val_logs["output_fin_img5"][i].cpu().numpy()
            target_t1 = val_logs["target_t1"][i].cpu().numpy()
            target_t2 = val_logs["target_t2"][i].cpu().numpy()
            target_pd = val_logs["target_pd"][i].cpu().numpy()
            target_ie = val_logs["target_ie"][i].cpu().numpy()
            ...
            mse_vals_ie[fname][slice_num] = torch.tensor(
                evaluate.mse(target_ie, output_ie)
            ).view(1)
            ...
            mse_vals_fin_img1[fname][slice_num] = torch.tensor(
                evaluate.mse(target_img1, output_fin_img1)
            ).view(1)
            mse_vals_fin_img2[fname][slice_num] = torch.tensor(
                evaluate.mse(target_img2, output_fin_img2)
            ).view(1)
            mse_vals_fin_img3[fname][slice_num] = torch.tensor(
                evaluate.mse(target_img3, output_fin_img3)
            ).view(1)
            mse_vals_fin_img4[fname][slice_num] = torch.tensor(
                evaluate.mse(target_img4, output_fin_img4)
            ).view(1)
            mse_vals_fin_img5[fname][slice_num] = torch.tensor(
                evaluate.mse(target_img5, output_fin_img5)
            ).view(1)
            ...
            target_norms_ie[fname][slice_num] = torch.tensor(
                evaluate.mse(target_ie, np.zeros_like(target_ie))
            ).view(1)
            ...
            ssim_vals_ie[fname][slice_num] = torch.tensor(
                evaluate.ssim(target_ie[None, ...], output_ie[None, ...], maxval=maxval_ie)
            ).view(1)
            ...
            ssim_vals_fin_img1[fname][slice_num] = torch.tensor(
                evaluate.ssim(target_img1[None, ...], output_fin_img1[None, ...], maxval=target_img1.max())
            ).view(1)
            ssim_vals_fin_img2[fname][slice_num] = torch.tensor(
                evaluate.ssim(target_img2[None, ...], output_fin_img2[None, ...], maxval=target_img2.max())
            ).view(1)
            ssim_vals_fin_img3[fname][slice_num] = torch.tensor(
                evaluate.ssim(target_img3[None, ...], output_fin_img3[None, ...], maxval=target_img3.max())
            ).view(1)
            ssim_vals_fin_img4[fname][slice_num] = torch.tensor(
                evaluate.ssim(target_img4[None, ...], output_fin_img4[None, ...], maxval=target_img4.max())
            ).view(1)
            ssim_vals_fin_img5[fname][slice_num] = torch.tensor(
                evaluate.ssim(target_img5[None, ...], output_fin_img5[None, ...], maxval=target_img5.max())
            ).view(1)
            max_vals_t1[fname] = maxval_t1
            max_vals_t2[fname] = maxval_t2
            max_vals_pd[fname] = maxval_pd
            max_vals_ie[fname] = maxval_ie
        ...
        return {
            ...
            "val_loss_ie": val_logs["val_loss_ie"],
            ...
            "val_loss_fin_img1": val_logs["val_loss_fin_img1"],
            "val_loss_fin_img2": val_logs["val_loss_fin_img2"],
            "val_loss_fin_img3": val_logs["val_loss_fin_img3"],
            "val_loss_fin_img4": val_logs["val_loss_fin_img4"],
            "val_loss_fin_img5": val_logs["val_loss_fin_img5"],
            "mse_vals_t1": dict(mse_vals_t1),
            "mse_vals_t2": dict(mse_vals_t2),
            "mse_vals_pd": dict(mse_vals_pd),
            "mse_vals_ie": dict(mse_vals_ie),
            ...
            "mse_vals_fin_img1": dict(mse_vals_fin_img1),
            "mse_vals_fin_img2": dict(mse_vals_fin_img2),
            "mse_vals_fin_img3": dict(mse_vals_fin_img3),
            "mse_vals_fin_img4": dict(mse_vals_fin_img4),
            "mse_vals_fin_img5": dict(mse_vals_fin_img5),
            "target_norms_t1": dict(target_norms_t1),
            "target_norms_t2": dict(target_norms_t2),
            "target_norms_pd": dict(target_norms_pd),
            "target_norms_ie": dict(target_norms_ie),
            ...
            "ssim_vals_ie": dict(ssim_vals_ie),
            ...
            "ssim_vals_fin_img1": dict(ssim_vals_fin_img1),
            "ssim_vals_fin_img2": dict(ssim_vals_fin_img2),
            "ssim_vals_fin_img3": dict(ssim_vals_fin_img3),
            "ssim_vals_fin_img4": dict(ssim_vals_fin_img4),
            "ssim_vals_fin_img5": dict(ssim_vals_fin_img5),
            "max_vals_t1": max_vals_t1,
            "max_vals_t2": max_vals_t2,
            "max_vals_pd": max_vals_pd,
            "max_vals_ie": max_vals_ie,
            ...
            "loss_weight_ie": val_logs["loss_weight_ie"],
            ...
            "loss_weight_fin_img1": val_logs["loss_weight_fin_img1"],
            "loss_weight_fin_img2": val_logs["loss_weight_fin_img2"],
            "loss_weight_fin_img3": val_logs["loss_weight_fin_img3"],
            "loss_weight_fin_img4": val_logs["loss_weight_fin_img4"],
            "loss_weight_fin_img5": val_logs["loss_weight_fin_img5"],
        }
    ...
    def validation_epoch_end(self, val_logs):
        ...
        for val_log in val_logs:
            ...
            losses_ie.append(val_log["val_loss_ie"].view(-1))
            ...
            losses_fin_img1.append(val_log["val_loss_fin_img1"].view(-1))
            losses_fin_img2.append(val_log["val_loss_fin_img2"].view(-1))
            losses_fin_img3.append(val_log["val_loss_fin_img3"].view(-1))
            losses_fin_img4.append(val_log["val_loss_fin_img4"].view(-1))
            losses_fin_img5.append(val_log["val_loss_fin_img5"].view(-1))
            ...
            for k in val_log["mse_vals_ie"].keys():
                mse_vals_ie[k].update(val_log["mse_vals_ie"][k])
            ...
            for k in val_log["mse_vals_fin_img1"].keys():
                mse_vals_fin_img1[k].update(val_log["mse_vals_fin_img1"][k])
            for k in val_log["mse_vals_fin_img2"].keys():
                mse_vals_fin_img2[k].update(val_log["mse_vals_fin_img2"][k])
            for k in val_log["mse_vals_fin_img3"].keys():
                mse_vals_fin_img3[k].update(val_log["mse_vals_fin_img3"][k])
            for k in val_log["mse_vals_fin_img4"].keys():
                mse_vals_fin_img4[k].update(val_log["mse_vals_fin_img4"][k])
            for k in val_log["mse_vals_fin_img5"].keys():
                mse_vals_fin_img5[k].update(val_log["mse_vals_fin_img5"][k])
            ...
            for k in val_log["target_norms_ie"].keys():
                target_norms_ie[k].update(val_log["target_norms_ie"][k])
            ...
            for k in val_log["ssim_vals_ie"].keys():
                ssim_vals_ie[k].update(val_log["ssim_vals_ie"][k])
            ...
            for k in val_log["ssim_vals_fin_img1"].keys():
                ssim_vals_fin_img1[k].update(val_log["ssim_vals_fin_img1"][k])
            for k in val_log["ssim_vals_fin_img2"].keys():
                ssim_vals_fin_img2[k].update(val_log["ssim_vals_fin_img2"][k])
            for k in val_log["ssim_vals_fin_img3"].keys():
                ssim_vals_fin_img3[k].update(val_log["ssim_vals_fin_img3"][k])
            for k in val_log["ssim_vals_fin_img4"].keys():
                ssim_vals_fin_img4[k].update(val_log["ssim_vals_fin_img4"][k])
            for k in val_log["ssim_vals_fin_img5"].keys():
                ssim_vals_fin_img5[k].update(val_log["ssim_vals_fin_img5"][k])
            ...
            for k in val_log["max_vals_ie"]:
                max_vals_ie[k] = val_log["max_vals_ie"][k]
        ...
        assert (
            ...
            == mse_vals_img4.keys()
            == mse_vals_img5.keys()
            == mse_vals_fin_img1.keys()
            == mse_vals_fin_img2.keys()
            == mse_vals_fin_img3.keys()
            == mse_vals_fin_img4.keys()
            == mse_vals_fin_img5.keys()
            == target_norms_t1.keys()
            == target_norms_t2.keys()
            == target_norms_pd.keys()
            == target_norms_ie.keys()
            ...
            == ssim_vals_img4.keys()
            == ssim_vals_img5.keys()
            == ssim_vals_fin_img1.keys()
            == ssim_vals_fin_img2.keys()
            == ssim_vals_fin_img3.keys()
            == ssim_vals_fin_img4.keys()
            == ssim_vals_fin_img5.keys()
            == max_vals_t1.keys()
            == max_vals_t2.keys()
            == max_vals_pd.keys()
            == max_vals_ie.keys()
        ...
        metrics = {"nmse_t1": 0, "nmse_t2": 0, "nmse_pd": 0, "nmse_ie": 0, \
                    "nmse_img1": 0, "nmse_img2": 0, "nmse_img3": 0, "nmse_img4": 0, "nmse_img5": 0,\
                    "nmse_fin_img1": 0, "nmse_fin_img2": 0, "nmse_fin_img3": 0, "nmse_fin_img4": 0, "nmse_fin_img5": 0,\
                    "ssim_t1": 0, "ssim_t2": 0, "ssim_pd": 0, "ssim_ie": 0, \
                    "ssim_img1": 0, "ssim_img2": 0, "ssim_img3": 0, "ssim_img4": 0, "ssim_img5": 0, \
                    "ssim_fin_img1": 0, "ssim_fin_img2": 0, "ssim_fin_img3": 0, "ssim_fin_img4": 0, "ssim_fin_img5": 0, \
                    "psnr_t1": 0, "psnr_t2": 0, "psnr_pd": 0, "psnr_ie": 0, \
                    "psnr_img1": 0, "psnr_img2": 0, "psnr_img3": 0, "psnr_img4": 0, "psnr_img5": 0, \
                    "psnr_fin_img1": 0, "psnr_fin_img2": 0, "psnr_fin_img3": 0, "psnr_fin_img4": 0, "psnr_fin_img5": 0}
        local_examples = 0
        for fname in mse_vals_t1.keys():
            ...
            mse_val_ie = torch.mean(
                torch.cat([v.view(-1) for _, v in mse_vals_ie[fname].items()])
            )
            ...
            mse_val_fin_img1 = torch.mean(
                torch.cat([v.view(-1) for _, v in mse_vals_fin_img1[fname].items()])
            )
            mse_val_fin_img2 = torch.mean(
                torch.cat([v.view(-1) for _, v in mse_vals_fin_img2[fname].items()])
            )
            mse_val_fin_img3 = torch.mean(
                torch.cat([v.view(-1) for _, v in mse_vals_fin_img3[fname].items()])
            )
            mse_val_fin_img4 = torch.mean(
                torch.cat([v.view(-1) for _, v in mse_vals_fin_img4[fname].items()])
            )
            mse_val_fin_img5 = torch.mean(
                torch.cat([v.view(-1) for _, v in mse_vals_fin_img5[fname].items()])
            )
            ...
            target_norm_ie = torch.mean(
                torch.cat([v.view(-1) for _, v in target_norms_ie[fname].items()])
            )
            ...
            metrics["nmse_ie"] = metrics["nmse_ie"] + mse_val_ie / target_norm_ie
            ...
            metrics["nmse_fin_img1"] = metrics["nmse_fin_img1"] + mse_val_fin_img1 / target_norm_img1
            metrics["nmse_fin_img2"] = metrics["nmse_fin_img2"] + mse_val_fin_img2 / target_norm_img2
            metrics["nmse_fin_img3"] = metrics["nmse_fin_img3"] + mse_val_fin_img3 / target_norm_img3
            metrics["nmse_fin_img4"] = metrics["nmse_fin_img4"] + mse_val_fin_img4 / target_norm_img4
            metrics["nmse_fin_img5"] = metrics["nmse_fin_img5"] + mse_val_fin_img5 / target_norm_img5
            metrics["psnr_t1"] = (
                metrics["psnr_t1"]
                + 20
                * torch.log10(
            ...
            metrics["psnr_ie"] = (
                ...
                * torch.log10(
                    torch.tensor(
                        max_vals_ie[fname], dtype=mse_val_ie.dtype, device=mse_val_ie.device
                    )[0]
                )
                - 10 * torch.log10(mse_val_ie)
            )
            metrics["psnr_img1"] = (
                metrics["psnr_img1"]
                + 20
            ...
            metrics["psnr_fin_img1"] = (
                metrics["psnr_fin_img1"]
                + 20
                * torch.log10(
                    torch.tensor(
                        max_vals_img1[fname], dtype=mse_val_fin_img1.dtype, device=mse_val_fin_img1.device
                    )[0]
                )
                - 10 * torch.log10(mse_val_fin_img1)
            )
            metrics["psnr_fin_img2"] = (
                metrics["psnr_fin_img2"]
                + 20
                * torch.log10(
                    torch.tensor(
                        max_vals_img2[fname], dtype=mse_val_fin_img2.dtype, device=mse_val_fin_img2.device
                    )[0]
                )
                - 10 * torch.log10(mse_val_fin_img2)
            )
            metrics["psnr_fin_img3"] = (
                metrics["psnr_fin_img3"]
                + 20
                * torch.log10(
                    torch.tensor(
                        max_vals_img3[fname], dtype=mse_val_fin_img3.dtype, device=mse_val_fin_img3.device
                    )[0]
                )
                - 10 * torch.log10(mse_val_fin_img3)
            )
            metrics["psnr_fin_img4"] = (
                metrics["psnr_fin_img4"]
                + 20
                * torch.log10(
                    torch.tensor(
                        max_vals_img4[fname], dtype=mse_val_fin_img4.dtype, device=mse_val_fin_img4.device
                    )[0]
                )
                - 10 * torch.log10(mse_val_fin_img4)
            )
            metrics["psnr_fin_img5"] = (
                metrics["psnr_fin_img5"]
                + 20
                * torch.log10(
                    torch.tensor(
                        max_vals_img5[fname], dtype=mse_val_fin_img5.dtype, device=mse_val_fin_img5.device
                    )[0]
                )
                - 10 * torch.log10(mse_val_fin_img5)
            )
            ...
            metrics["ssim_ie"] = metrics["ssim_ie"] + torch.mean(
                torch.cat([v.view(-1) for _, v in ssim_vals_ie[fname].items()])
            )
            ...
            metrics["ssim_fin_img1"] = metrics["ssim_fin_img1"] + torch.mean(
                torch.cat([v.view(-1) for _, v in ssim_vals_fin_img1[fname].items()])
            )
            metrics["ssim_fin_img2"] = metrics["ssim_fin_img2"] + torch.mean(
                torch.cat([v.view(-1) for _, v in ssim_vals_fin_img2[fname].items()])
            )
            metrics["ssim_fin_img3"] = metrics["ssim_fin_img3"] + torch.mean(
                torch.cat([v.view(-1) for _, v in ssim_vals_fin_img3[fname].items()])
            )
            metrics["ssim_fin_img4"] = metrics["ssim_fin_img4"] + torch.mean(
                torch.cat([v.view(-1) for _, v in ssim_vals_fin_img4[fname].items()])
            )
            metrics["ssim_fin_img5"] = metrics["ssim_fin_img5"] + torch.mean(
                torch.cat([v.view(-1) for _, v in ssim_vals_fin_img5[fname].items()])
            )
        ...
        metrics["nmse_ie"] = self.NMSE(metrics["nmse_ie"])
        ...
        metrics["nmse_fin_img1"] = self.NMSE(metrics["nmse_fin_img1"])
        metrics["nmse_fin_img2"] = self.NMSE(metrics["nmse_fin_img2"])
        metrics["nmse_fin_img3"] = self.NMSE(metrics["nmse_fin_img3"])
        metrics["nmse_fin_img4"] = self.NMSE(metrics["nmse_fin_img4"])
        metrics["nmse_fin_img5"] = self.NMSE(metrics["nmse_fin_img5"])
        ...
        metrics["ssim_ie"] = self.SSIM(metrics["ssim_ie"])
        ...
        metrics["ssim_fin_img1"] = self.SSIM(metrics["ssim_fin_img1"])
        metrics["ssim_fin_img2"] = self.SSIM(metrics["ssim_fin_img2"])
        metrics["ssim_fin_img3"] = self.SSIM(metrics["ssim_fin_img3"])
        metrics["ssim_fin_img4"] = self.SSIM(metrics["ssim_fin_img4"])
        metrics["ssim_fin_img5"] = self.SSIM(metrics["ssim_fin_img5"])
        ...
        metrics["psnr_ie"] = self.PSNR(metrics["psnr_ie"])
        ...
        metrics["psnr_fin_img1"] = self.PSNR(metrics["psnr_fin_img1"])
        metrics["psnr_fin_img2"] = self.PSNR(metrics["psnr_fin_img2"])
        metrics["psnr_fin_img3"] = self.PSNR(metrics["psnr_fin_img3"])
        metrics["psnr_fin_img4"] = self.PSNR(metrics["psnr_fin_img4"])
        metrics["psnr_fin_img5"] = self.PSNR(metrics["psnr_fin_img5"])
        ...
        val_loss = self.ValLoss((torch.sum(torch.cat(losses_t1)) * val_log["loss_weight_t1"] + torch.sum(torch.cat(losses_t2)) * val_log["loss_weight_t2"] + \
                                    torch.sum(torch.cat(losses_pd)) * val_log["loss_weight_pd"] + torch.sum(torch.cat(losses_ie)) * val_log["loss_weight_ie"] + \
                                    ...
                                    torch.sum(torch.cat(losses_fin_img1)) * val_log["loss_weight_fin_img1"] + torch.sum(torch.cat(losses_fin_img2)) * val_log["loss_weight_fin_img2"] + \
                                    torch.sum(torch.cat(losses_fin_img3)) * val_log["loss_weight_fin_img3"] + torch.sum(torch.cat(losses_fin_img4)) * val_log["loss_weight_fin_img4"] + \
                                    torch.sum(torch.cat(losses_fin_img5)) * val_log["loss_weight_fin_img5"]) \
                                / (val_log["loss_weight_t1"] + val_log["loss_weight_t2"] + val_log["loss_weight_pd"] + val_log["loss_weight_ie"] + \
                                    ...
                                    val_log["loss_weight_fin_img1"] + val_log["loss_weight_fin_img2"] + val_log["loss_weight_fin_img3"] + val_log["loss_weight_fin_img4"] + val_log["loss_weight_fin_img5"]))
    ...
    def test_epoch_end(self, test_logs):
        ...
        fastmri.save_reconstructions_qalas(outputs_t1, outputs_t2, outputs_pd, outputs_ie, save_path)
